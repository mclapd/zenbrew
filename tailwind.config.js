...
module.exports = {
  ...
  theme: {
    ...
    screens: { sm: "640px", md: "768px", lg: "960px", xl: "1430px" },
    fontFamily: {
    ...
    extend: {
      colors: {
        primary: { DEFAULT: "#100e0e" },
        secondary: { DEFAULT: "#787f8a" },
        accent: { DEFAULT: "#c7a17a", hover: "#a08161" },
      },
      backgroundImage: {
        hero_overlay: "url('/assets/here/hero_overlay.png')",
